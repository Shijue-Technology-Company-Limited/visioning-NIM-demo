...
public class PixelBuffer {
    ...
    public void setRenderer(final GPUImageRenderer renderer) {
        ...
        mRenderer.init(mGL, mEGLConfig);
        mRenderer.setOutput(mGL, mWidth, mHeight);
    }
    ...
    private ByteBuffer readPixels() {
        ...
        if(mRgbBuffer == null) {
            mRgbBuffer = ByteBuffer.allocateDirect(mWidth * mHeight << 2);
        }

        mGL.glReadPixels(0, 0, mWidth, mHeight, GL_RGBA, GL_UNSIGNED_BYTE, mRgbBuffer);
