...
///////////////////////////////////////////////////////////
-(void)startShaper;
///	cmd: 人脸整形指令，见下定义"FacerCmd***"
///	strength: 该指令整形强度，一般为-1~1，<0代表反向效果
-(void)setShaping:(int)cmd strength:(float)strength;
-(void)stopShaper;
...
{
#endif
extern int	FacerCmdSlimer,
FacerCmdVJaw;

extern int	FacerEmoOpenMouth,
FacerEmoSmile,
FacerEmoMoveEyebowLeft,
FacerEmoMoveEyebowRight,
FacerEmoBlinkEyeLeft,
FacerEmoBlinkEyeRight;
#ifdef	__cplusplus
}
#endif
